...
-- Usuario por contacto: cada contacto puede tener su propio acceso al sistema
ALTER TABLE "CLIENTE_CONTACTO" ADD COLUMN IF NOT EXISTS "user_id" BIGINT;
ALTER TABLE "CLIENTE_CONTACTO" DROP CONSTRAINT IF EXISTS "fk_contacto_user";
ALTER TABLE "CLIENTE_CONTACTO" ADD CONSTRAINT "fk_contacto_user"
    FOREIGN KEY ("user_id") REFERENCES "CHEMI_USERS"("ID");
ALTER TABLE "CLIENTE_CONTACTO" DROP CONSTRAINT IF EXISTS "uq_contacto_user";
ALTER TABLE "CLIENTE_CONTACTO" ADD CONSTRAINT "uq_contacto_user" UNIQUE ("user_id");
...
-- Migrar límites numéricos a texto libre (preserva decimales como "1.0", "0.50", etc.)
DO $$ BEGIN
    ALTER TABLE "RESOL_DESTINO_PARAM" ALTER COLUMN "VALOR_MIN" TYPE VARCHAR(50) USING "VALOR_MIN"::text;
EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN
    ALTER TABLE "RESOL_DESTINO_PARAM" ALTER COLUMN "VALOR_MAX" TYPE VARCHAR(50) USING "VALOR_MAX"::text;
EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN
    ALTER TABLE "ANALISIS_PARAM_LIMITE" ALTER COLUMN "LIMITE_MIN" TYPE VARCHAR(50) USING "LIMITE_MIN"::text;
EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN
    ALTER TABLE "ANALISIS_PARAM_LIMITE" ALTER COLUMN "LIMITE_MAX" TYPE VARCHAR(50) USING "LIMITE_MAX"::text;
EXCEPTION WHEN others THEN NULL; END $$;
